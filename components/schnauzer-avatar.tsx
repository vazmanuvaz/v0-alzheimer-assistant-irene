...
const IMAGES = {
  idle: '/dog-ears-down.png?t=' + Date.now(),
  blink: '/dog-blink.png?t=' + Date.now(),
  listening: '/dog-ears-up.png?t=' + Date.now(),
  speaking: '/dog-mouth-open.png?t=' + Date.now(),
  sleeping: '/dog-sleeping.png?t=' + Date.now(),
} as const;
